...
description: Full backend architecture for REIMAGINEDAPPV2 including the DIP pipeline, LLM retrieval, and recent system updates.
---

> **Info:** This document describes the REIMAGINEDAPPV2 backend as of October 2025.  
> It includes the latest DIP table migration, worker removal, Python sidecar integration, and LLM retrieval enhancements.
...
<iframe
  src="https://structurizr.com/share/107225/diagram/system-context"
  width="100%"
  height="700"
...
> **Info:** This live Structurizr diagram updates automatically when the backend model changes.  
> Workspace ID: 107225 | [View in Structurizr Cloud](https://structurizr.com/workspace/107225)
