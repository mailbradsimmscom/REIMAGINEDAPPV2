---
title: shouldSummarizeThread, getSummarizationMetadata
description: Summarize a conversation thread @param {Array} messages - Conversation messages @param {Array} systemsContext - Systems context @returns {Promise<string>} - Generated summary
---
