---
title: SupabaseMemoryManager, createMemoryManager
description: Drop-in replacement for LangChain's PostgresChatMessageHistory Uses your existing Supabase chat_threads and chat_messages tables
---
