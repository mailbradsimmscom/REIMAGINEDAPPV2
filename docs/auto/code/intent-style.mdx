---
title: decideStyle, getStyleOpening
description: Determines the appropriate style preset based on the user's question @param {string} question - The user's question @returns {'specBrief'|'steps'|'bullets3'|'brief'|'technical'} - The style preset to use
---
