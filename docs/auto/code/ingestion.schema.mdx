---
title: DIPSchema, SuggestionsSchema, ApplyRequestSchema, ApplyResponseSchema, RollbackRequestSchema, RollbackResponseSchema, validateDIP, validateSuggestions, validateApplyRequest, validateRollbackRequest, createDefaultDIP, createDefaultSuggestions
description: Ingestion schemas for DIP (Document Intelligence Packet) and Suggestions Provides validation for document analysis results and admin suggestions
---
