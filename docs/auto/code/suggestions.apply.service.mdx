---
title: Module
description: Suggestions apply service - merges accepted suggestions into JSON config files Provides safe application of admin-approved changes with snapshot safety
---
