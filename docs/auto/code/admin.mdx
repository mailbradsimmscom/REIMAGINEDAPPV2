---
title: adminGate, adminOnly
description: Optional admin gate - only checks if token is provided Useful for routes that can work with or without admin access
---
