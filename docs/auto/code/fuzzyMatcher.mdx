---
title: FuzzyMatcher, fuzzyMatcher
description: Fuzzy matching utility for handling typos in maintenance tokens and units Uses Levenshtein distance algorithm for approximate string matching
---
