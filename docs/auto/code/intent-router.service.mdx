---
title: Module
description: Classify user query intent and determine processing pipeline @param {string} userQuery - The user's query @returns {Promise<Object>} - Intent classification result
---
