---
title: chatDebug, timed
description: Chat Debug Logger TEMPORARY - Remove after migration is complete * Usage - import { chatDebug } from '../utils/chat-debug-logger.js'; chatDebug.step('STEP_NAME', { data - 'value' });
---
