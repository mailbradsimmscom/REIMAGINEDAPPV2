---
title: anthropicExtractionService
description: Service for Anthropic extraction processing Handles business logic for extracting structured data using Anthropic Claude
---
