---
title: Module
description: Perform spec-biased retrieval from Pinecone @param {Object} params - Retrieval parameters @param {string} params.query - The search query @param {string} params.namespace - Pinecone namespace @param {Object} params.context - Additional context @returns {Promise<Object>} - Retrieval results with metadata
---
