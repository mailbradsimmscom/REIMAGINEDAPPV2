---
title: uploadDocumentSchema, flexibleUploadDocumentSchema, documentUploadRequestSchema, systemMetadataSchema, documentCreationSchema
description: Schema for validating normalized document upload metadata Ensures manufacturer_norm and model_norm are provided and non-empty
---
