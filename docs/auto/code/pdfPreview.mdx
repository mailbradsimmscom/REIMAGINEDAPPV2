---
title: Module
description: Extract text preview from multiple sources in priority order - 1. Supabase Storage - documents/manuals/<docId>/text/preview.txt or text/page-*.txt 2. Postgres table - document_chunks (fallback) 3. Log warning if neither available
---
