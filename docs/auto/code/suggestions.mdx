---
title: init
description: Suggestions section controller Handles AI-generated suggestions management and approval workflow Now supports all four DIP table types - spec_suggestions, playbook_hints, intent_router, golden_tests
---
