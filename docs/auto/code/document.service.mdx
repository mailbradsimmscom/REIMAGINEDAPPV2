---
title: Module
description: Create an ingest job for document processing @param {Buffer} fileBuffer - The PDF file buffer @param {Object} metadata - Document metadata @returns {Object} Created job
---
