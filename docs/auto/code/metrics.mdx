---
title: MetricsCollector, metrics
description: Metrics collection utility for tracking fuzzy matching and context operations Provides performance monitoring and success rate tracking
---
