---
title: BasicHealthEnvelope, ServiceStatusEnvelope, ReadinessEnvelope, healthResponseSchema, healthQuerySchema, EmptyQuery, adminHealthResponseSchema, adminHealthErrorSchema
