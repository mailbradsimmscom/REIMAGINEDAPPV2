---
title: anthropicExtractionRepository
description: Repository for Anthropic extraction data operations Handles all I/O operations for storing Anthropic extraction results
---
