---
title: Module
description: Service for ingesting DIP JSON outputs into Supabase database tables Handles normalization and insertion of spec_suggestions, playbook_hints, intent_router, and golden_tests
---
