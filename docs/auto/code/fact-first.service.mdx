---
title: shouldAttemptFactFirst
description: Check if query matches any facts in the knowledge_facts materialized view @param {string} query - The user query @returns {Promise<Object|null>} - Fact match result or null
---
