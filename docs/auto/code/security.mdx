---
title: securityHeaders, basicRateLimit
description: Security middleware - adds essential security headers Equivalent to Helmet.js but lightweight and customized
---
