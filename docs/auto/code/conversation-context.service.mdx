---
title: Module
description: Conversation Context Service * Handles weighted conversation memory with fading importance. Recent exchanges get full context, older ones get compressed.
---
