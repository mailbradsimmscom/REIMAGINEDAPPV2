---
title: getTextExtractionMetrics, clearTextCache, getCacheStats
description: Document Text Extraction Service Multi-source text extractor - DB chunks → Storage text → graceful fallback Includes caching and performance monitoring
---
