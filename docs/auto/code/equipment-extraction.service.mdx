---
title: Module
description: Extract equipment name from natural language query using LLM * @param {string} query - User's natural language query @returns {Promise<{equipment - Array}>} - Object containing array of extracted equipment with name, confidence, role
---
